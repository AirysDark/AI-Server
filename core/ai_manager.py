...
def blank_settings(uid,ai_id):
    return {"user_id":uid,"ai_id":ai_id,"setup_complete":False,"ai_name":"","profile_photo":"","description":"","background":"","user_information":"","user_name":"","personality":"","instructions":"","api_provider":"huggingface","api_token":"","hf_token":"","google_token":"","openai_token":"","gemini_api_key":"","api_endpoint":"","api_model":"","config":{"traits":[],"rules":[]},"features":{"online_ai":True,"learning":True,"long_term_memory":True,"relevant_memory":True,"automatic_images":False,"proactive_images":False},"proactive":{"enabled":False}}
