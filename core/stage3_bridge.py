...
def apply():
    module = server_impl
    for name, value in {"PORT": PORT, "PUBLIC_HOSTNAME": PUBLIC_HOSTNAME, "PUBLIC_URL": PUBLIC_URL, "RECENT_CONTEXT_MESSAGES": RECENT_CONTEXT_MESSAGES, "RELEVANT_MEMORY_LIMIT": RELEVANT_MEMORY_LIMIT, "PROACTIVE_MIN_MINUTES": PROACTIVE_MIN_MINUTES, "PROACTIVE_MAX_MINUTES": PROACTIVE_MAX_MINUTES, "MAX_AIS_PER_ACCOUNT": MAX_AIS_PER_ACCOUNT, "BASE_DIR": BASE_DIR, "USERS_DIR": USERS_DIR, "AUTH_FILE": AUTH_FILE, "SESSIONS_FILE": SESSIONS_FILE, "AIS_FILE": AIS_FILE}.items():
